...
public final class CatDatabaseConfigurator extends AbstractJdbcResourceConfigurator {
	...
	public List<Component> defineComponents() {
        ...
        defineSimpleTableProviderComponents(all, "cat", com.dianping.cat.core.myconfig._INDEX.getEntityClasses());
        defineDaoComponents(all, com.dianping.cat.core.myconfig._INDEX.getDaoClasses());
		return all;
	}
}
